...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func noNetworkAlert() {
        ...
        view.configureContent(title: "No connection", body: "Things may act a little wonky")
    ...
    func application(_ application: UIApplication,
        ...
        // [END register_for_notifications]
             ...
             self.initialViewController = storyboard.instantiateViewController(withIdentifier: "PagesNavVC")
    ...
    func application(_ application: UIApplication, didReceiveRemoteNotification userInfo: [AnyHashable: Any]) {
        ...
        notification.alertBody = "BALLS DAMN" // text that will be displayed in the notification
    ...
    func application(_ application: UIApplication, didReceiveRemoteNotification userInfo: [AnyHashable: Any],
        ...
        //PagesViewController.notifyHistory()
        
        if let messageID = userInfo[gcmMessageIDKey] {
            print("1Message ID: \(messageID)")
            (initialViewController?.childViewControllers[0] as? PagesViewController)?.notifyHistory()
        }
...
extension AppDelegate : UNUserNotificationCenterDelegate {
    ...
    func userNotificationCenter(_ center: UNUserNotificationCenter,
        ...
        if let messageID = userInfo[gcmMessageIDKey] {
            ...
            //(window?.rootViewController as? PagesViewController)?.notifyHistory()
            (initialViewController?.childViewControllers[0] as? PagesViewController)?.notifyHistory()
        }
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didReceiveRemoteNotification userInfo: [AnyHashable: Any]) {
        ...
        // this callback will not be fired till the user taps on the notification launching the application.
        // TODO: Handle data of notification
        print("--REMOTE NOTIFICATION RECEIVED, A")
        // With swizzling disabled you must let Messaging know about the message, for Analytics
        Messaging.messaging().appDidReceiveMessage(userInfo)
    ...
    func application(_ application: UIApplication, didReceiveRemoteNotification userInfo: [AnyHashable: Any],
        ...
        // this callback will not be fired till the user taps on the notification launching the application.
        // TODO: Handle data of notification
        print("--REMOTE NOTIFICATION RECEIVED, B")
        // With swizzling disabled you must let Messaging know about the message, for Analytics
        Messaging.messaging().appDidReceiveMessage(userInfo)
...
/*
    ...
    func application(received remoteMessage: MessagingRemoteMessage) {
        print("--Received remote message from FCM!", remoteMessage.appData)
    }
...
extension AppDelegate: MessagingDelegate {
    ...
    func messaging(_ messaging: Messaging, didReceive remoteMessage: MessagingRemoteMessage) {
        print("--Received FCM FIR message!", remoteMessage.appData)
    }
